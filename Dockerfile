...
INSTALL_PKGS="unzip git cargo nano npm python3-devel openssl-devel python3-pip python3-cryptography python3-mod_wsgi python3-wheel python3-setuptools bash-completion jq libffi-devel libtool-ltdl httpd mod_ssl mod_session supervisor bc java-1.8.0-openjdk java-1.8.0-openjdk-devel" && \
